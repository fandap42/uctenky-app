-- CreateEnum
CREATE TYPE "AppRole" AS ENUM ('MEMBER', 'HEAD_VEDENI', 'HEAD_FINANCE', 'HEAD_HR', 'HEAD_PR', 'HEAD_NEVZDELAVACI', 'HEAD_VZDELAVACI', 'HEAD_SPORTOVNI', 'HEAD_GAMING', 'HEAD_KRUHOVE', 'ADMIN');
...
-- CreateTable
CREATE TABLE "debt_errors" (
    "id" TEXT NOT NULL,
    "amount" DECIMAL(12,2) NOT NULL,
    "reason" TEXT NOT NULL,
    "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,

    CONSTRAINT "debt_errors_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "cash_on_hand" (
    ...
    CONSTRAINT "cash_on_hand_pkey" PRIMARY KEY ("id")
);
