/*
  ...
  - You are about to drop the column `store` on the `tickets` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE "tickets" DROP COLUMN "store",
ADD COLUMN     "is_filed" BOOLEAN NOT NULL DEFAULT false,
